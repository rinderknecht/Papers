...
\paragraph{Elements and unification.}
...
\begin{enumerate}
  ...
  \item \label{algo:tree_insertion} Insert the element in the \XML
    ...
    stream order, see \fig{fig:rightmost_branches}).
  ...
  \item \label{algo:border_expansion} If the insertion results in the
    ...
    \fig{fig:rightmost_branches} and further formal definition);
...
out in increasing order. As shown in \fig{fig:rightmost_branches},
