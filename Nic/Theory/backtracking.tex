...
Soundness and completeness are properties that suppose another level
...
\noindent we must use meta\-parentheses to explicit the tree
structure, because parentheses would not pair the way we want ---~in
fact, they would not pair at all.
