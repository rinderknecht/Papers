...
\newcommand{\CEbigand}[1]{\stackrel{\pmb{..}}{\bigwedge_{#1}}}
...
\newcommand{\CEeqI}{\CEeq}
\newcommand{\CEeqR}{\CEeq}
\newcommand{\CEeqS}{\CEeq}
\newcommand{\CEeqF}{\CEeq}

%% Operators on Powerset Constraint Expressions (PSCE)
%%
%\newcommand{\PSCEeq}{\ddeq{P}}

\newcommand{\PSCEeq}{\CEeq}
...
\divide\dimen0 by2%
\mathbin{\vbox{\hphantom{$\cup$}\nointerlineskip\hbox{\box0\kern -\dimen0\raise 1mm\box1}}}}

\newcommand{\bigfunupdate}{%
\setbox0=\hbox{$\bigcup$}%
\setbox1=\hbox{\toto{+}}%
\dimen0=\the\wd0%
\dimen1=\the\wd1%
...
\newcommand{\wildSET}{\kwdSET \,\!\wildcard}
\newcommand{\wildSEQUENCE}{\kwdSEQUENCE \,\!\wildcard}
...
\newcommand{\wildBITSTRING}{\kwdBITSTRING \, \wildcard}
\newcommand{\wildSETOF}{\kwdSETOF \, \wildcard}
\newcommand{\wildSEQUENCEOF}{\kwdSEQUENCEOF \, \wildcard}
